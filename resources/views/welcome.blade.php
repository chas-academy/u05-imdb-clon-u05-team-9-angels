...
@section('content')
<section
      class="min-h-2/4 bg-gray-400 flex flex-col pt-40 justify-center text-white bg-no-repeat bg-center bg-cover	"
      style='background-image: url("https://image.tmdb.org/t/p/w500/{{$movies[0]->poster}}")'
    >
        ...
        <div>
          ...
          <div class="flex items-center mt-6">
            ...
            <div class="flex flex-col md:flex-row ml-2">
              ...
              <a class="font-bold md:ml-1 underline">användarvillkår</a>
            </div>
          </div>
        </div>
