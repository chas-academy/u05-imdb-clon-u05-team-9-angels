                    ...
                    <div class="container w-max-50 pl-16 pt-16 mb-10 flex" style="margin-top:-300px">
                        <div>
                            <img class="mb-3"
                                ...
                                <a class="border border-indigo-500 bg-indigo-500 text-white rounded-md px-4 py-2 transition duration-500 ease select-none hover:bg-indigo-600 focus:outline-none focus:shadow-outline">Add to list</a>
                                <p class="mt-2 ml-2">10</p> 
