        ...
        <main class="container mx-auto pt-2 px-4 bg-imdb-black text-white">
            ...
            <div class="movie-wrapper flex flex-col sm:flex-row gap-x-4 gap-y-2">
                ...
                <div class="col2">
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            @foreach ($cast as $character)
                                                                @if ($character->actors_id == $print->id)
                                                                    <p class="text-gray-800">{{ $character->character }}
                                                                    </p>
                                                                @endif
                                                            @endforeach
                                                        </div>
                    ...
                    {{-- end movie holder --}}
                    {{-- Comment Section --}}
                    <section class="grid grid-cols-1 gap-6 mt-10">
                        <form class="text-white bg-imdb-card rounded-lg px-4 pt-2 mt-5" method="POST"
                            ...
                            @foreach ($comments as $comment)
                                <div class="mb-4">
                                    <div class="overflow-hidden shadow-md text-gray-100">
                                        <div
                                            class="px-6 py-4 bg-imdb-card border-b border-gray-600 font-bold uppercase rounded-t-lg">
                                            {{ $comment->user->name }}
                                        </div>
                                        <div class="p-6 bg-imdb-card border-b border-gray-600">
                                            ...
                                            <div
                                                class="p-6 bg-imdb-card border-gray-200 flex items-center text-gray-400 text-sm rounded-b-lg">
                                                ...
                                                @if ($can_edit)
                                                    <form method="POST"
                                                        action="/movies/comment/delete/{{ $comment->id }}">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit"
                                ...
                                <div class="p-6 bg-red-300 rounded-lg my-2">
                                    <div class="overflow-hidden shadow-md text-gray-700">
                                        ...
                                        <div class="border-gray-400 flex items-center text-gray-700 text-sm">
                                            ...
                                            @if ($can_edit)
                                                <form method="POST"
                                                    action="/movies/comment/delete/{{ $pendingComment->id }}">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit"
                                                        class=" bg-red-500 ml-4 hover:bg-red-700 text-white font-bold py-2 px-4 border border-red-700 rounded cursor-pointer">Delete
                                                ...
                                                <form method="POST"
                                                    action="/movies/comment/update/{{ $pendingComment->id }}">
                                                    @csrf
                                                    <button type="submit"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="modal-content py-4 text-left px-6">
                                <!--Title-->
                                <div class="flex justify-between items-center pb-3">
                                    <h3 class="text-2xl font-bold text-white">Are you sure you want to delete
                                        {{ $movies->title }}?</h3>
