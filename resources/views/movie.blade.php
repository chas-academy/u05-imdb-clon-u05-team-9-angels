        ...
        <div>
            ...
            <div class="form-container mx-14">
                <form method="POST" action="/movies/edit/{{ $movies->id }}">
                    ...
                    <input type="text" id="title" name="movie" value="{{ $movies->title }}" required><br>
                    <input type="hidden" id="title" name="id" value="{{ $movies->id }}">
                    <br>

                    <label for="description">Description:</label><br>
                    <input type="text" id="title" name="movie" value="{{ $movies->description }}" required><br>
                    <input type="hidden" id="title" name="id" value="{{ $movies->id }}">
                    <br>
                    ...
                    <input type="text" id="year" name="year" value="{{ $movies->year }}" required><br>
                    <input type="hidden" id="year" name="id" value="{{ $movies->id }}">
                    <br>
