                    ...
                    <div class="container w-max-50 pl-16 pt-16 mb-10 flex" style="margin-top:-300px">
                        <div>
                            ...
                            <div class="rating-container justify-left flex mb-2">
                                <button><a href="{{ url('/movies/add-to-watchlist/' . $movies->id) }}"
                                        class="border border-indigo-500 bg-green-500 text-white rounded-md px-4 py-2 transition duration-500 ease select-none hover:bg-green-600 focus:outline-none focus:shadow-outline">Add
                                        to list</a></button>


                                <button><a href="{{ url('/movies/remove-from-watchlist/' . $watchlist->id) }}" class="border border-indigo-500 bg-red-500 text-white rounded-md px-4 py-2 transition
                                                        duration-500 ease select-none hover:bg-red-600 focus:outline-none
                                                        focus:shadow-outline">Remove from list</a></button>
